...
const FormStep04 = () => {
  ...
  const options = [
    {label: <RadioOptionCard number={'1'} name={'Repayment'}/>, value: 'Repayment'},
    {label: <RadioOptionCard number={'2'} name={'Interests only'}/>, value: 'Interests only'},
  ]
  return (
    <Form
      layout={'vertical'}
      onFinish={onFinish}
      autoComplete={'off'}
      initialValues={{repayment: documentInfo?.repayment}}
