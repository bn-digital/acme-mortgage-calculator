...
const FormStep09 = () => {
  ...
  const options = [
    {label: <RadioOptionCard number={'1'} name={'Fixed'}/>, value: 'Fixed'},
    {label: <RadioOptionCard number={'2'} name={'Variable'}/>, value: 'Variable'},
    {label: <RadioOptionCard number={'3'} name={'Flex'}/>, value: 'Flex'},
  ]
  return (
    <Form
      layout={'vertical'}
      onFinish={onFinish}
      autoComplete={'off'}
      initialValues={{productType: documentInfo?.productType}}
